...
//    public func logOut()
//    {
//        KeychainWrapper.global.removeObject(forKey: kWatchTokenV3, withAccessibility: .afterFirstUnlock)
//        KeychainWrapper.global.removeObject(forKey: kWatchToken, withAccessibility: .afterFirstUnlock)
...
//            KeychainWrapper.global.set(encodedToken, forKey: kWatchTokenV3, withAccessibility: .afterFirstUnlock)
//        }
//    }
//
//    
//    func getV2Token() -> Data? {
//        if let tokenJson = KeychainWrapper.global.data(forKey: kWatchToken, withAccessibility: .afterFirstUnlock)
//        {
...
//        if let tokenJson = KeychainWrapper.global.data(forKey: kWatchTokenV3, withAccessibility: .afterFirstUnlock)
//        {
//            if (try? JSONDecoder().decode(Token.self, from: tokenJson)) != nil
//            {
//                return tokenJson
...
//                if let encodedToken = try? JSONEncoder().encode(token) {
//                    KeychainWrapper.global.set(encodedToken, forKey: kWatchToken, withAccessibility: .afterFirstUnlock)
//                }
//                else
//                {
