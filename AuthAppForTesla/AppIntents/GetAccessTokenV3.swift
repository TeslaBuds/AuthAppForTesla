...
struct GetAccessTokenV3: AppIntent, CustomIntentMigratedAppIntent {
    static let intentClassName = "GetAccessTokenIntent"

    static var title: LocalizedStringResource = "Get Owners API Access Token"
    static var description = IntentDescription("Returns the Owners API access token")
